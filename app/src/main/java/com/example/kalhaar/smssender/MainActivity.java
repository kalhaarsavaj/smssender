package com.example.kalhaar.smssender;
...
public class MainActivity extends AppCompatActivity {
    ...
    EditText etPhone, etMessage, etCounter;
    Button btnSendSMS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etCounter = (EditText)findViewById(R.id.etCount);
        ...
        btnSendSMS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int c = Integer.parseInt(etCounter.getText().toString());
